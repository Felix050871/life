...
## Recent Changes
- July 21, 2025: **Sistema Presenze Dinamico per Sede** - Implementata funzionalità per Responsabili di visualizzare presenze utenti della propria sede: aggiunto supporto view_mode 'sede', filtro per utenti stessa sede, pulsanti dinamici basati su permessi can_view_attendance configurabili dall'admin, template aggiornato con controlli condizionali

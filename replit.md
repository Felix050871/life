...
## Recent Changes
- July 30, 2025: **Sistema Overlay Loading Ripristinato con Esclusione Export** - Ripristinato sistema overlay globale completo in base.html per tutte le operazioni eccetto export: overlay attivo su form submission e navigazione link interni, esclusi specificamente link con href*="export" per prevenire problemi con download file, timeout fallback 30 secondi, listener per visibilitychange/beforeunload per pulizia automatica, sistema completo per feedback UX su tutte le operazioni pesanti mantenendo funzionalità export senza interferenze

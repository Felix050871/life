...
## Recent Changes
- August 7, 2025: **Sistema Permessi Gerarchico Implementato** - Implementata logica corretta dei permessi dove `can_manage_*` include automaticamente `can_view_*`. Risolti problemi di accesso admin alla gestione ruoli. Sistema ora segue principio logico: Gestire = Modificare + Visualizzare, Visualizzare = Solo lettura. Configurati 4 ruoli base (Amministratore, Responsabile, Supervisore, Operatore) con permessi granulari appropriati.

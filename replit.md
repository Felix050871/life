...
- **HR Data Management (October 2025)**: Comprehensive employee information system with sensitive data protection, featuring:
  ...
  - **Three-Tier Sede Architecture** (October 24, 2025): 
    1. **`UserHRData.sede_id`** = "Sede di assunzione" - Administrative/contractual field indicating where employee was hired (managed in HR module)
    2. **`User.sede_id`** = "Sede operativa corrente" - Current operational sede for permission-based filtering and as default for new events (managed in User Management)

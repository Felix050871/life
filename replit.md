...
## Recent Changes
- August 7, 2025: **Models.py Ristrutturazione Completata** - Riorganizzato il file models.py (2.700+ righe, 25 classi) in 12 sezioni logiche: User Management, Attendance & Time Tracking, Leave Management, Shift Management, Reperibilità, Intervention, Administrative, Expense Management, Overtime Management, Mileage Management, System Configuration. Aggiunto header organizzativo completo e struttura coerente con routes.py.

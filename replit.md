...
## Recent Changes
- July 30, 2025: **Sistema Overlay Loading Completo Ripristinato** - Ripristinato sistema overlay globale completo in base.html per tutte le operazioni incluso export: overlay attivo su form submission, navigazione link interni e operazioni export, timeout fallback 30 secondi, listener per visibilitychange/beforeunload per pulizia automatica, sistema completo per feedback UX su tutte le operazioni pesanti con gestione automatica overlay per migliore esperienza utente

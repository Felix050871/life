...
## Recent Changes
- July 30, 2025: **Sistema Overlay Loading Definitivamente Risolto** - Eliminato completamente il sistema di overlay globale da base.html che causava schermo nero persistente dopo export Excel: rimosso LoadingManager class e tutti i suoi event listeners automatici, eliminato overlay HTML globalLoadingOverlay, rimosse funzioni showLoading/hideLoading globali, sistema dashboard_team ora usa solo feedback sui pulsanti senza overlay full-screen, risolto definitivamente problema UX critico che bloccava interfaccia dopo operazioni export
